 ...
 */
public class newMonthlyIncome extends javax.swing.JFrame {

    /**
     * Creates new form newMonthlyIncome
     */
    public newMonthlyIncome() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        MonthlyIncomePanel.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 140, -1, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 2, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(204, 204, 204));
        jLabel4.setText("YYYY");
        MonthlyIncomePanel.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 120, 40, -1));
        ...
        jLabel13.setText("MM");
        MonthlyIncomePanel.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 120, 20, -1));
        ...
        jLabel14.setText("DD");
        MonthlyIncomePanel.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 120, 20, -1));
        MonthlyIncomePanel.add(txtFromDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 140, 50, -1));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setText("Year To");
        MonthlyIncomePanel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 220, -1, -1));

        jLabel15.setFont(new java.awt.Font("Tahoma", 2, 12)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(204, 204, 204));
        jLabel15.setText("YYYY");
        MonthlyIncomePanel.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 200, 40, -1));
        ...
        jLabel16.setText("MM");
        MonthlyIncomePanel.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 200, 30, -1));
        MonthlyIncomePanel.add(txtToMonth, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 220, 50, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 2, 12)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(204, 204, 204));
        jLabel2.setText("DD");
        MonthlyIncomePanel.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 200, 20, -1));
        ...
        MonthlyIncomePanel.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 270, 140, 40));
        ...
        MonthlyIncomePanel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 320, 730, 150));
        ...
        MonthlyIncomePanel.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 500, -1, -1));

        getContentPane().add(MonthlyIncomePanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1080, 560));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(newMonthlyIncome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new newMonthlyIncome().setVisible(true);
            }
        });
    }
